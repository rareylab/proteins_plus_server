...
class ProtossJob(ProteinsPlusJob):
    ...
    input_protein = models.ForeignKey(
        Protein, on_delete=models.CASCADE, related_name='child_protoss_job_set')
    input_ligand = models.ForeignKey(
        Ligand, on_delete=models.CASCADE, null=True, related_name='child_protoss_job_set')
    output_protein = models.OneToOneField(
        Protein, on_delete=models.CASCADE, null=True, related_name='parent_protoss_job')
