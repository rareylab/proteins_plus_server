    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('atom_scores', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='ediascorer.atomscores')),
                ('electron_density_map', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='child_edia_job_set', to='molecule_handler.electrondensitymap')),
        ...
        migrations.AddField(
            model_name='atomscores',
            name='parent_edia_job',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='ediascorer.ediajob'),
        ),
    ]
